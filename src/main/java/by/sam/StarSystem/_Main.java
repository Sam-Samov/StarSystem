...
public class _Main {
    public static void main(String[] args) {
        ...
        planet3Satellite1.setMass(7.3477e+22);
        ...
        planet4.setMass(6.4171e+23);
        Satellite[] planet4SatellitesArr = new Satellite[0];
        planet4.setSatellitesArr(planet4SatellitesArr);
        Satellite planet4Satellite1 = new Satellite();
        planet4Satellite1.setSatelliteName("Фобос");
        planet4Satellite1.setMass(1.072e+16);
        Satellite planet4Satellite2 = new Satellite();
        planet4Satellite2.setSatelliteName("Деймос");
        planet4Satellite2.setMass(1.48e+15);
        ...
        System.out.println("Количество звёзд в системе: " + solarSystem.getStarsArr().length);
        System.out.println("Количество планет в системе: " + solarSystem.getPlanetsArr().length);
        services.printAmountSatellites(solarSystem);
    }
}